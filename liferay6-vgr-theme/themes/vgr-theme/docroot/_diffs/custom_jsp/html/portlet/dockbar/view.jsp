...
<div class="dockbar" data-namespace="<portlet:namespace />" id="dockbar">
	<ul class="aui-toolbar">
		...
		<c:if test="<%= !group.isControlPanel() && (permissionChecker.isOmniadmin() || permissionChecker.isCommunityAdmin(portletGroupId)) && (themeDisplay.isShowControlPanelIcon() || themeDisplay.isShowPageSettingsIcon() || themeDisplay.isShowLayoutTemplatesIcon()) %>">
		...
		<c:if test="<%= !group.isControlPanel() && themeDisplay.isSignedIn() && (permissionChecker.isOmniadmin() || permissionChecker.isCommunityAdmin(portletGroupId)) %>">
